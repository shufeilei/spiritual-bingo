...
ActiveRecord::Schema.define(version: 2021_11_17_191122) do
  ...
  create_table "cells", charset: "utf8mb4", force: :cascade do |t|
    t.integer "row"
    t.integer "col"
    t.text "response"
  ...
  create_table "commontator_comments", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "commontator_subscriptions", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "thread_id", null: false
  ...
  create_table "commontator_threads", charset: "utf8mb4", force: :cascade do |t|
